...
window.switchRichTab = function(tabIndex) {
  ...
  const rawLogo = token.logoURI || token.image || token.icon || 'assets/base-logo.png';
  ...
  if (tabIndex === 0) {
    ...
    content.innerHTML = `
      <div class="about-tab" style="animation: punchIn 0.3s ease;">
        <img src="${tokenLogo}" class="banner" style="width:80px;height:80px;border-radius:50%;border:2px solid ${mainColor};margin-bottom:10px;object-fit:cover;" onerror="this.onerror=null;this.src='assets/base-logo.png'">
