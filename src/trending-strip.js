  ...
  render() {
    this.container.innerHTML = `
      <div class="strip-header" style="display:flex; justify-content:space-between; align-items:center; width:100%;">
        ...
        <div style="display:flex; align-items:center; gap:6px; margin:0 auto; flex:0 0 auto;">
          <button onclick="window.showWalletConnect && window.showWalletConnect()" style="display:inline-flex; align-items:center; justify-content:center; background:rgba(0,0,0,0.6); border:1px solid var(--neon-green); min-width:58px; height:22px; border-radius:999px; font-family:var(--font-print, 'Press Start 2P', system-ui, sans-serif); font-size:8px; color:#fff; cursor:pointer; box-shadow:0 0 8px rgba(20,241,149,0.45); transition:all 0.2s; user-select:none; padding:0 8px;" onmouseover="this.style.transform='translateY(-1px)'" onmouseout="this.style.transform='translateY(0)'" title="User Profile & Wallet">PROFILE</button>
          <div onclick="window.openHelpModal && window.openHelpModal()" style="display:inline-flex; align-items:center; justify-content:center; background:rgba(0,0,0,0.6); border:1px solid var(--neon-pink); width:22px; height:22px; border-radius:50%; font-family:var(--font-display, 'Shojumaru', 'Press Start 2P', sans-serif); font-size:11px; color:#fff; cursor:pointer; box-shadow:0 0 8px var(--neon-pink); transition:all 0.2s; user-select:none;" onmouseover="this.style.transform='scale(1.15)';" onmouseout="this.style.transform='scale(1)';" title="Game Guide">i</div>
        </div>
